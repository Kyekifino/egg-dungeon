...
export const KRAKEN_BODY_PARTS = [
  ...
  // Row 5: upper mantle flanks (curved, not angular wings)
  [
    '  ~(   |~~~~~~~~~|   )~  ',
    '  ~ )  |~~~~~~~~~|  ( ~  ',
    '  ~~(  |~~~~~~~~~|  )~~  ',
  ...
  // Row 6: mantle at widest — tentacle flanks, not wing spread
  [
    '~  (   |~~~~~~~~~|   )  ~',
    ' ~ (~  |~~~~~~~~~|  ~) ~ ',
    '~   ~  |~~~~~~~~~|  ~   ~',
  ...
  // Row 9: body bottom narrowing toward tentacle base
  [
    '    ~(  ~~~~~~~~~~  )~   ',
    '     ~  ~~~~~~~~~~  ~    ',
    '    ~~  ~~~~~~~~~~  ~~   ',
  ...
  // Row 10: tentacle branching (not hips/haunches)
  [
    '   ~)  ~~~~~~~~~~~  (~   ',
    '  ~)~  ~~~~~~~~~~~  ~(~  ',
    '  ~~)  ~~~~~~~~~~~  (~~  ',
  ...
  // Row 11: tentacles mid (not upper legs)
  [
    ' ~(  )~              ~(  )~ ',
    '  ~~  )~            ~(  ~~  ',
    '  ~)   ~            ~   (~  ',
  ...
  // Row 12: lower tentacles (not lower legs)
  [
    '  ~(   )~          ~(   )~  ',
    ' ~~  ~~              ~~  ~~ ',
    '  ~(~)~              ~(~)~  ',
  ...
  // Row 13: tentacle tips (not claws/feet)
  [
    '  (~)  (~)         (~)  (~) ',
    '  ~~    ~~           ~~    ~~',
    '  ~~)  (~~         ~~)  (~~ ',
